...
declare module "vs/workbench/workbench.web.main" {
	...
	function isFileOpenForWriteOptions(
		options: FileOpenOptions,
	): options is FileOpenForWriteOptions;
	...
	export {
		...
		type IWebSocket,
		// Resources
		type IResourceUriProvider,
		// Credentials
		type ICredentialsProvider,
		// Static Extensions
		type IStaticExtension,
